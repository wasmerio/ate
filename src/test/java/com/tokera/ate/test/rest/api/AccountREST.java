...
public class AccountREST {
    ...
    @PermitAll
    public String createAdminToken(@PathParam("username") @Valid @EmailAddress String username, @Valid MessagePrivateKeyDto key) {
        // Set the alias in the key to be the username
        key = d.encryptor.createPrivateKey(key, username);
