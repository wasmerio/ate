...
{
    @JsonProperty
    private final ImmutalizableHashSet<PrivateKeyWithSeedDto> rightsRead = new ImmutalizableHashSet<>();
    @JsonProperty
    private final ImmutalizableHashSet<PrivateKeyWithSeedDto> rightsWrite = new ImmutalizableHashSet<>();
