 ...
 * XMSS^MT Public Key.
 */
public final class XMSSMTPublicKeyParametersPredictable
        ...
        implements XMSSStoreableObjectInterface, Encodable
{
    ...
    private XMSSMTPublicKeyParametersPredictable(Builder builder)
    {
    ...
    public static class Builder
    {
        ...
        public XMSSMTPublicKeyParametersPredictable build()
        {
            return new XMSSMTPublicKeyParametersPredictable(this);
        }
    }
