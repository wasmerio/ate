 ...
 * XMSS^MT Private Key.
 */
public final class XMSSMTPrivateKeyParametersPredictable
        ...
        implements XMSSStoreableObjectInterface
{
    ...
    private XMSSMTPrivateKeyParametersPredictable(Builder builder)
    {
    ...
    public static class Builder
    {
        ...
        public XMSSMTPrivateKeyParametersPredictable build()
        {
            return new XMSSMTPrivateKeyParametersPredictable(this);
        }
    }
    ...
    public XMSSMTPrivateKeyParametersPredictable getNextKey()
    {
        BDSStateMap newState = new BDSStateMap(bdsState, params, this.getIndex(), publicSeed, secretKeySeed);

        return new XMSSMTPrivateKeyParametersPredictable.Builder(params).withIndex(index + 1)
