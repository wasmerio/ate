...
public class Table {
     ...
     *
     * @param vtable_offset An `int` offset to the vtable in the Table's
     * ByteBuffer.
    ...
    protected static int __offset(int vtable_offset, int offset, @NonNull ByteBuffer bb) {
     ...
     *
     * @param offset An `int` index into the Table's ByteBuffer containing the
     * relative offset.
    ...
    protected static int __indirect(int offset, @NonNull ByteBuffer bb) {
        return offset + bb.getInt(offset);
    }
     ...
     * `offset`.
     */
    protected @NonNull String __string(int offset) {
     ...
     *
     * This is efficient, since it only allocates a new {@link ByteBuffer}
     * object, but does not actually copy the data, it still refers to the same
     * bytes as the original ByteBuffer. Also useful with nested FlatBuffers,
     * etc.
     *
     ...
     */
    protected @Nullable ByteBuffer __vector_as_bytebuffer(int vector_offset, int elem_size) {
     ...
     *
     * This is more efficient than using duplicate, since it doesn't copy the
     * data nor allocattes a new {@link ByteBuffer}, creating no garbage to be
     * collected.
     *
     ...
     * @return The {@link ByteBuffer} for the array
     */
    protected @Nullable ByteBuffer __vector_in_bytebuffer(@NonNull ByteBuffer bb, int vector_offset, int elem_size) {
     ...
     * `offset`.
     *
     * @param t A `Table`-derived type that should point to the union at
     * `offset`.
     * @param offset An `int` index into the Table's ByteBuffer.
     * @return Returns the Table that points to the union at `offset`.
     */
    protected @NonNull Table __union(@NonNull Table t, int offset) {
        offset += bb_pos;
     ...
     */
    protected static boolean __has_identifier(@NonNull ByteBuffer bb, @NonNull String ident) {
     ...
     */
    protected void sortTables(int @NonNull [] offsets, final @NonNull ByteBuffer bb) {
     ...
     * @param bb A {@code ByteBuffer} to get the toPutKeys.
     */
    protected int keysCompare(@NonNull Integer o1, @NonNull Integer o2, @NonNull ByteBuffer bb) {
        return 0;
    }
     ...
     */
    protected static int compareStrings(int offset_1, int offset_2, @NonNull ByteBuffer bb) {
     ...
     */
    protected static int compareStrings(int offset_1, byte @NonNull [] key, @NonNull ByteBuffer bb) {
        offset_1 += bb.getInt(offset_1);
        int len_1 = bb.getInt(offset_1);
    ...
    public @Nullable String toBase64(@NonNull ByteBuffer bb) {
        if (bb.remaining() <= 0) {
            return null;
        }
