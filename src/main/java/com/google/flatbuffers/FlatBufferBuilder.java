...
public class FlatBufferBuilder {
    ...
    int[] vtable = null;            // The vtable for the currentRights table.
    ...
    int object_start;               // Starting offset of the currentRights struct/table.
    int[] vtables = new int[16];    // List of offsets of all vtables.
    int num_vtables = 0;            // Number of entries in `vtables` in use.
    int vector_num_elems = 0;       // For the currentRights vector being built.
     ...
     */
    public FlatBufferBuilder(int initial_size, @NonNull ByteBufferFactory bb_factory) {
    ...
    */
     ...
     */
    public FlatBufferBuilder(@NonNull ByteBuffer existing_bb, @NonNull ByteBufferFactory bb_factory) {
     ...
     * @param existing_bb The byte buffer to reuse.
     */
    public FlatBufferBuilder(@NonNull ByteBuffer existing_bb) {
     ...
     * @return Returns `this`.
     */
    public @NonNull FlatBufferBuilder init(@NonNull ByteBuffer existing_bb, @NonNull ByteBufferFactory bb_factory){
        this.bb_factory = bb_factory;
        bb = existing_bb;
        bb.clear();
    ...
    public interface ByteBufferFactory {
         ...
         */
        @NonNull ByteBuffer newByteBuffer(int capacity);
         ...
         */
        default void releaseByteBuffer(@NonNull ByteBuffer bb) {
        }
    }
    ...
    public static final class HeapByteBufferFactory implements ByteBufferFactory {
        @Override
        public @NonNull ByteBuffer newByteBuffer(int capacity) {
     ...
     *
     * @param bb The currentRights buffer with the existing data.
     ...
     */
    static @NonNull ByteBuffer growByteBuffer(@NonNull ByteBuffer bb, @NonNull ByteBufferFactory bb_factory) {
    ...
    */
    ...
    /**
     * Add a `boolean` to the buffer, backwards from the currentRights location. Doesn't align nor
     * check for space.
     *
    ...
    /**
     * Add a `byte` to the buffer, backwards from the currentRights location. Doesn't align nor
     * check for space.
     *
    ...
    /**
     * Add a `short` to the buffer, backwards from the currentRights location. Doesn't align nor
     * check for space.
     *
    ...
    /**
     * Add an `int` to the buffer, backwards from the currentRights location. Doesn't align nor
     * check for space.
     *
    ...
    /**
     * Add a `long` to the buffer, backwards from the currentRights location. Doesn't align nor
     * check for space.
     *
    ...
    /**
     * Add a `float` to the buffer, backwards from the currentRights location. Doesn't align nor
     * check for space.
     *
    ...
    /**
     * Add a `double` to the buffer, backwards from the currentRights location. Doesn't align nor
     * check for space.
     *
    ...
    */
     ...
     */
    public @NonNull ByteBuffer createUnintializedVector(int elem_size, int num_elems, int alignment) {
   ...
   /**
     ...
     */
    public int createVectorOfTables(int @NonNull [] offsets) {
        notNested();
     ...
     */
    public <T extends Table> int createSortedVectorOfTables(@NonNull T obj, int @NonNull [] offsets) {
    ...
    */
    public int createString(@NonNull CharSequence s) {
        int length = s.length();
    ...
    * @return The offset in the buffer where the encoded string starts.
    */
    public int createString(@NonNull ByteBuffer s) {
     ...
     */
    public int createByteVector(byte @NonNull [] arr) {
    ...
    /**
     * Add a ByteBuffer to the buffer, properly aligned, and grows the buffer (if necessary).     *
     * @param x A ByteBuffer to put into the buffer.
     */
    public int addByteBuffer(@NonNull ByteBuffer x)
    {
        int length = Constants.SIZEOF_BYTE * x.remaining();
        prep(length, 0);
        bb.position(space -= length);
        bb.put(x);
        return offset();
    ...
    */
    ...
    /**
     * Set the currentRights vtable at `voffset` to the currentRights location in the buffer.
     *
    ...
    */
    public int endObject() {
        ...
        // Write out the currentRights vtable.
        ...
        // Search for an existing vtable that matches the currentRights one.
     ...
     * @param size_prefix Whether to prefix the size to the buffer.
     */
    protected void finish(int root_table, @NonNull String file_identifier, boolean size_prefix) {
     ...
     * `root_table`.
     */
    public void finish(int root_table, @NonNull String file_identifier) {
     ...
     * `root_table`.
     */
    public void finishSizePrefixed(int root_table, @NonNull String file_identifier) {
     ...
     * @return Returns `this`.
     */
    public @NonNull FlatBufferBuilder forceDefaults(boolean forceDefaults){
     ...
     * called `finish()`. The actual data starts at the ByteBuffer's currentRights position,
     * not necessarily at `0`.
     *
     * @return The {@link ByteBuffer} representing the FlatBuffer
     */
    public @NonNull ByteBuffer dataBuffer() {
        finished();
        return bb;
    }
    ...
    */
    public byte @NonNull [] sizedByteArray(int start, int length){
        finished();
    ...
    */
    public byte @NonNull [] sizedByteArray() {
     ...
     */
    public @NonNull InputStream sizedInputStream() {
        finished();
    ...
    static class ByteBufferBackedInputStream extends InputStream {
        ...
        public ByteBufferBackedInputStream(@NonNull ByteBuffer buf) {
            this.buf = buf;
        }
