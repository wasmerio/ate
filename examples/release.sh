...
cp -f ../target/wasm32-wasmer-wasi/release/condvar.wasm /prog/ate/wasmer-web/public/bin/example-condvar.wasm
cp -f ../target/wasm32-wasmer-wasi/release/stack.wasm /prog/ate/wasmer-web/public/bin/example-stack.wasm
...
cp -f ../target/wasm32-wasmer-wasi/release/multi-threading.wasm /prog/wasmer/lib/wasi/tests/multi-threading.wasm
cp -f ../target/wasm32-wasmer-wasi/release/condvar.wasm /prog/wasmer/lib/wasi/tests/condvar.wasm
cp -f ../target/wasm32-wasmer-wasi/release/stack.wasm /prog/wasmer/lib/wasi/tests/stack.wasm
