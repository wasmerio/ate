...
use atessh::term_lib;
use term_lib::fs::MountedFileSystem;
use term_lib::bus::WasmCallerContext;
use term_lib::wasmer_vfs::*;
...
pub struct FileAccessorAdapter
{
    ...
    inner: tokera::bus::file_system::FileSystem,
}
...
impl FileAccessorAdapter
{
    pub fn new(accessor: &Arc<FileAccessor>) -> Self {
        Self {
            ...
            inner: tokera::bus::file_system::FileSystem::new(
                accessor.clone(),
                RequestContext {
                    uid: 0,
                    gid: 0,
...
pub struct FileAccessorVirtualFile {
    fs: FileAccessorAdapter,
    of: Arc<tokera::bus::opened_file::OpenedFile>,
    io: Arc<tokera::bus::file_io::FileIo>,
...
fn conv_io_err(err: wasm_bus_fuse::api::FsError) -> io::Error {
    err.into()
}

fn conv_fs_err(err: wasm_bus_fuse::api::FsError) -> FsError {
    use wasm_bus_fuse::api::FsError as E;
    match err {
