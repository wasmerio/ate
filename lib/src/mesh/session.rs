...
impl MeshSession
{
    ...
    -> Result<Arc<Chain>, ChainCreationError>
    {
        ...
        let mut chain = {
            ...
            let mut chain = Chain::new_ext(builder.clone(), chain_key, Some(Box::new(loader_local)), true, TrustMode::Centralized(CentralizedRole::Client), TrustMode::Distributed).await?;
