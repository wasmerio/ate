...
pub async fn group_user_remove_command(registry: &Registry, session: &AteSessionGroup, purpose: AteRolePurpose, username: String, auth: Url) -> Result<GroupUserRemoveResponse, GroupUserRemoveError>
{
