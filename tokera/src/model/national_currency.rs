...
impl NationalCurrency
{
    ...
    {
        match self {
            NationalCurrency::NON => ("Unknown currency", "000", 0, false, false, false, false, None),
            NationalCurrency::TOK => ("Tokera Coin", "001", 0, true, true, false, true, Some("coin.tokera.com")),
            NationalCurrency::INV => ("Tokera Invest","002", 0, false, true, false, false, Some("invest.tokera.com")),
            NationalCurrency::BIT => ("Bitcoin", "003", 0, false, false, false, false, Some("bitcoin.exchange.tokera.com")),
            NationalCurrency::EUR => ("Euro", "978", 2, false, true, true, false, Some("eur.exchange.tokera.com")),
            NationalCurrency::USD => ("US Dollar", "840", 2, false, true, true, false, Some("usd.exchange.tokera.com")),
            NationalCurrency::AUD => ("Australian Dollar", "036", 2, false, true, true, false, Some("aud.exchange.tokera.com")),
            NationalCurrency::HKD => ("Hong Kong Dollar", "344", 2, false, true, true, false, Some("hkd.exchange.tokera.com")),
            NationalCurrency::CNY => ("Yuan Renminbi", "156", 2, false, true, false, false, Some("cny.exchange.tokera.com")),
            NationalCurrency::GBP => ("Pound Sterling", "826", 2, false, true, true, false, Some("gbp.exchange.tokera.com")),
            NationalCurrency::AAD => ("Antarctic Dollar", "004", 2, false, false, true, false, None),
            ...
            NationalCurrency::XCD => ("East Caribbean Dollar", "951", 2, false, false, false, false, None),
            ...
            NationalCurrency::AZN => ("Azerbaijanian Manat", "944", 2, false, false, false, false, None),
            NationalCurrency::BSD => ("Bahamian Dollar", "044", 2, false, false, false, false, None),
            ...
            NationalCurrency::BBD => ("Barbados Dollar", "052", 2, false, false, false, false, None),
            NationalCurrency::BYR => ("Belarussian Ruble", "974", 0, false, false, false, false, None),
            NationalCurrency::BZD => ("Belize Dollar", "084", 2, false, false, false, false, None),
            NationalCurrency::BMD => ("Bermudian Dollar", "060", 2, false, false, false, false, None),
            ...
            NationalCurrency::NOK => ("Norwegian Krone", "578", 2, false, false, false, false, None),
            ...
            NationalCurrency::CAD => ("Canadian Dollar", "124", 2, false, false, false, false, None),
            NationalCurrency::CVE => ("Cape Verde Escudo", "132", 2, false, false, false, false, None),
            NationalCurrency::KYD => ("Cayman Islands Dollar", "136", 2, false, false, false, false, None),
            NationalCurrency::CLF => ("Unidad de Fomento", "990", 4, false, false, false, false, None),
            ...
            NationalCurrency::COU => ("Unidad de Valor Real", "970", 2, false, false, false, false, None),
            NationalCurrency::KMF => ("Comoro Franc", "174", 0, false, false, false, false, None),
            NationalCurrency::CDF => ("Congolese Franc", "976", 2, false, false, false, false, None),
            NationalCurrency::NZD => ("New Zealand Dollar", "554", 2, false, false, false, false, None),
            NationalCurrency::CRC => ("Costa Rican Colon", "188", 2, false, false, false, false, None),
            NationalCurrency::HRK => ("Croatian Kuna", "191", 2, false, false, false, false, None),
            NationalCurrency::CUC => ("Peso Convertible", "931", 2, false, false, false, false, None),
            NationalCurrency::CUP => ("Cuban Peso", "192", 2, false, false, false, false, None),
            NationalCurrency::ANG => ("Netherlands Antillean Guilder", "532", 2, false, false, false, false, None),
            ...
            NationalCurrency::SVC => ("El Salvador Colon", "222", 2, false, false, false, false, None),
            ...
            NationalCurrency::FKP => ("Falkland Islands Pound", "238", 2, false, false, false, false, None),
            ...
            NationalCurrency::GIP => ("Gibraltar Pound", "292", 2, false, false, false, false, None),
            ...
            NationalCurrency::ILS => ("New Israeli Sheqel", "376", 2, false, false, false, false, None),
            NationalCurrency::JMD => ("Jamaican Dollar", "388", 2, false, false, false, false, None),
            NationalCurrency::JPY => ("Yen", "392", 0, false, false, false, false, None),
            NationalCurrency::JOD => ("Jordanian Dinar", "400", 3, false, false, false, false, None),
            NationalCurrency::KZT => ("Tenge", "398", 2, false, false, false, false, None),
            NationalCurrency::KES => ("Kenyan Shilling", "404", 2, false, false, false, false, None),
            NationalCurrency::KPW => ("North Korean Won", "408", 2, false, false, false, false, None),
            ...
            NationalCurrency::LRD => ("Liberian Dollar", "430", 2, false, false, false, false, None),
            ...
            NationalCurrency::LTL => ("Lithuanian Litas", "440", 2, false, false, false, false, None),
            ...
            NationalCurrency::MGA => ("Malagasy Ariary", "969", 2, false, false, false, false, None),
            NationalCurrency::MWK => ("Kwacha", "454", 2, false, false, false, false, None),
            NationalCurrency::MYR => ("Malaysian Ringgit", "458", 2, false, false, false, false, None),
            ...
            NationalCurrency::MUR => ("Mauritius Rupee", "480", 2, false, false, false, false, None),
            ...
            NationalCurrency::MAD => ("Moroccan Dirham", "504", 2, false, false, false, false, None),
            NationalCurrency::MZN => ("Mozambique Metical", "943", 2, false, false, false, false, None),
            ...
            NationalCurrency::PHP => ("Philippine Peso", "608", 2, false, false, false, false, None),
            ...
            NationalCurrency::RON => ("New Romanian Leu", "946", 2, false, false, false, false, None),
            ...
            NationalCurrency::SHP => ("Saint Helena Pound", "654", 2, false, false, false, false, None),
            ...
            NationalCurrency::SCR => ("Seychelles Rupee", "690", 2, false, false, false, false, None),
            NationalCurrency::SLL => ("Leone", "694", 2, false, false, false, false, None),
            NationalCurrency::SGD => ("Singapore Dollar", "702", 2, false, false, false, false, None),
            NationalCurrency::XSU => ("Sucre", "994", 0, false, false, false, false, None),
            NationalCurrency::SBD => ("Solomon Islands Dollar", "090", 2, false, false, false, false, None),
            NationalCurrency::SOS => ("Somali Shilling", "706", 2, false, false, false, false, None),
            NationalCurrency::SSP => ("South Sudanese Pound", "728", 2, false, false, false, false, None),
            NationalCurrency::LKR => ("Sri Lanka Rupee", "144", 2, false, false, false, false, None),
            ...
            NationalCurrency::TWD => ("New Taiwan Dollar", "901", 2, false, false, false, false, None),
            NationalCurrency::TJS => ("Somoni", "972", 2, false, false, false, false, None),
            NationalCurrency::TZS => ("Tanzanian Shilling", "834", 2, false, false, false, false, None),
            ...
            NationalCurrency::TTD => ("Trinidad and Tobago Dollar", "780", 2, false, false, false, false, None),
            ...
            NationalCurrency::TMT => ("Turkmenistan New Manat", "934", 2, false, false, false, false, None),
            NationalCurrency::UGX => ("Uganda Shilling", "800", 0, false, false, false, false, None),
            ...
            NationalCurrency::XAF => ("Central African CFA franc", "950", 0, false, false, false, false, None),
            NationalCurrency::XOF => ("West African CFA franc", "952", 0, false, false, false, false, None),
            NationalCurrency::BAM => ("Bosnia and Herzegovina convertible mark", "977", 2, false, false, false, false, None),
            NationalCurrency::ZMW => ("Zambian Kwacha", "967", 2, false, false, false, false, None),
            NationalCurrency::ZWL => ("Zimbabwe Dollar", "932", 2, false, false, false, false, None),
...
for NationalCurrency
{
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        Err(std::io::Error::new(std::io::ErrorKind::Other, format!("Currency is not valid: {}.", s)))
    }
}
