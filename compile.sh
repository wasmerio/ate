...
mkdir -p bin-lib
mvn install:install-file -Dfile=target/ate-0.2.jar -DgroupId=com.tokera -DartifactId=ate -Dversion=0.2 -Dpackaging=jar -DlocalRepositoryPath=bin-lib -DpomFile=pom.xml
