...
pub struct Wallet {
    ...
    /// This secure broker key is used by Wasmer to access this wallet but can only
    /// be acquired by the owner of the wallet sharing it (given that Wasmer does not store it)
